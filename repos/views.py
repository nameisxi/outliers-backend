...
def create_repos(request):
    ...
    avg_stargarzers_count = GithubRepo.objects.all().aggregate(Avg('stargazers_count'))['stargazers_count__avg']
    max_stargarzers_count = GithubRepo.objects.all().aggregate(Max('stargazers_count'))['stargazers_count__max']

    return HttpResponse(f'GithubRepo objects: {GithubRepo.objects.count()}\nGithubRepoContributor objects: {GithubRepoContributor.objects.count()}, Avg stars: {avg_stargarzers_count}, Max stars: {max_stargarzers_count}')
