...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0003_alter_candidate_options'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='pre_profile',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='candidate', to='users.preprofile'),
        ),
    ]
