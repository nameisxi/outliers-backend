...
from .github_contributions_calendar_serializer import GithubContributionsCalendarSerializer
...
class FullGithubAccountSerializer(serializers.ModelSerializer):
    ...
    contributions = GithubContributionsCalendarSerializer(many=True, read_only=True)
